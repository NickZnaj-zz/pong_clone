...
/***/ function(module, exports, __webpack_require__) {
	...
	Ball.prototype.draw = function(ctx) {
	  if (this.pastPositions.length > 50)  this.pastPositions.splice(0, 1);
	  this.drawGhost(ctx);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Paddle.prototype.willNotBeOutOfBoundsDown = function() {
	  return (this.pos[1]  + this.height < this.canvasSize[1]);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	GameView.prototype.gameOver = function(){
	  return (
	    this.game.score.human  >= 1000 ||
	    this.game.score.ai  >= 1000
	  );
