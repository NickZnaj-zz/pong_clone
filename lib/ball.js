...
Ball.prototype.draw = function(ctx) {
  if (this.pastPositions.length > 100)  this.pastPositions.splice(0, 1);
  this.drawGhost(ctx);
...
Ball.prototype.newCurvingVel = function(xInitial, yInitial) {
  ...
  this.spin = this.shiftY / 5 || this.spin;


  if (shiftY !== 0){
    if (shiftY < -5) shiftY = -5;
    if (shiftY > 5) shiftY = 5;
  }
  var maxF = 1.3;
...
Ball.prototype.isCollided = function(paddle){
  ...
  if ( paddle.human ) {
    ...
    if ((this.pos[0] - this.radius < topRight[0]) && // main side
    ...
    if ((this.pos[0] + this.radius > topLeft[0] ) &&     // top side
    ...
    (this.collisionPoint = "side")){return true;}

    if ((this.pos[0] > bottomLeft[0] ) &&
    (this.pos[0] < bottomRight[0] ) &&             // bottom side
    (this.pos[1] - this.radius < bottomLeft[1]) &&
    (this.pos[1] + this.radius > bottomLeft[1]) &&
    (this.collisionPoint = "bottom")){return true;}
